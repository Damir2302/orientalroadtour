...
function jsPlugins(cb) {
	return gulp.src([
		pathTo.resolve('src', 'assets/js/vendor/jquery-3.3.1.min.js'),
        pathTo.resolve('src', 'assets/js/vendor/popper.min.js'),
        pathTo.resolve('src', 'assets/js/vendor/bootstrap.min.js'),
        pathTo.resolve('src', 'assets/js/vendor/owl.carousel.min.js'),
        pathTo.resolve('src', 'assets/js/vendor/jarallax.min.js'),
        pathTo.resolve('src', 'assets/js/vendor/jarallax-element.min.js'),
        pathTo.resolve('src', 'assets/js/vendor/ofi.min.js'),
